...
* Social Media Integration - Integrates with Facebook &amp; Google+ &amp; LinkedIn [image-1](http://www.cminds.com/wp-content/uploads/edd/image1.png) [Image-2](http://www.cminds.com/wp-content/uploads/edd/cm-answers-image2.png)
...
* User Questions &amp; Answers - You can add "My Questions" and "My Answers" profile views per user anywhere on the site by using shortcodes: cma-my-questions and cma-my-answers [Image](http://www.cminds.com/wp-content/uploads/edd/cm-answers-image3.png)
* Categories - Ability to add categories and display on different pages in site by using shortcode cat=catname
* Widgets - Added Widget which can display hotest questions, most viewed, recent and more [Image](http://www.cminds.com/wp-content/uploads/edd/cm-answers-image4.png)
* User Posting Meter - Ability to add near each user  number of questions and answers already posted [Image](http://www.cminds.com/wp-content/uploads/edd/cm-answers-image5.png)
* Show/Hide Views - Admin can hide or show number of views [Image](http://www.cminds.com/wp-content/uploads/edd/cm-answers-image6.png)
* Auto-approve questions and answers from users</strong>- Admin can define list of users which do not need moderation [Image](http://www.cminds.com/wp-content/uploads/edd/cm-answers-image7.png)
* Multisite - Supports multisite
* User Profile - Automaticly generate a profile page per each user containing the questions and answers he posted with link to social media profile [Image](http://www.cminds.com/wp-content/uploads/edd/cm-answers-image8.png)
